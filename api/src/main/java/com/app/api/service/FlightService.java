...
import com.app.repos.FlightChangesRepository;
...
public class FlightService {
    ...
    @Autowired
    FlightChangesRepository changesRepository;
    ...
    public Flight saveFlight(Flight flight) throws Exception{
        ...
        if (old.isPresent()){
            FlightChanges changes = FlightChanges.builder()
                .flight(old.get())
                .changeTime(LocalDateTime.now())
                .flyStatus(old.get().getStatus()).addTime(old.get().getAddTime()).build();
